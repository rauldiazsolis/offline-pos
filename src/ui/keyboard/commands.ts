/**
 * Comandos disponibles en Fase 1, para la lista que se muestra con solo "/"
 * (§7 del doc de diseño: "la barra enseña en vez de requerir memorización").
 * El comportamiento real de cada uno vive en `command-bar-controller.ts` —
