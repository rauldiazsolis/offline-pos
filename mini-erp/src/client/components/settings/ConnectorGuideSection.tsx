  ...
  return (
    <div class="space-y-6">
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 class="text-base font-bold text-white flex items-center gap-2">
              ...
              <span class="px-2 py-0.5 rounded-full bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 text-[10px] font-mono font-bold">
                Contrato v4.0.0
              </span>
            </h3>
        ...
        <div class="pt-2">
          ...
          <div class="flex items-center gap-2 max-w-xl">
            <input
              ...
              readOnly
              value={connectorUrl}
              class="flex-1 px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl font-mono text-xs text-indigo-300 focus:outline-none"
            />
        ...
        {/* Resultado del Ping */}
        {info && (
          <div class="p-4 rounded-xl bg-slate-950/60 border border-slate-800 flex items-center gap-4 text-xs animate-in fade-in duration-150">
            <div class="w-3 h-3 rounded-full bg-emerald-500 shadow-sm shadow-emerald-500/50 animate-pulse"></div>
            <div>
              <span class="text-white font-bold">Conexión Verificada: </span>
              <span class="text-slate-400">
                Versión: <strong class="text-emerald-400 font-mono">{info.version}</strong> • Estado:{' '}
                <strong class="text-emerald-400 font-mono uppercase">{info.status}</strong> • Verificado a las{' '}
                {info.checkedAt}
              </span>
            </div>
          </div>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
        <h4 class="text-sm font-bold text-white">¿Cómo vincular tu caja registradora Offline POS?</h4>

        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
          <div class="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2 text-xs">
            <div class="w-7 h-7 rounded-lg bg-indigo-600/20 text-indigo-400 flex items-center justify-center font-bold">
              1
            </div>
            <div class="font-bold text-white">Ingresar al POS</div>
          ...
          <div class="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2 text-xs">
            ...
            <div class="font-bold text-white">Pegar Credenciales</div>
            <p class="text-slate-400 leading-relaxed">
          ...
          <div class="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-2 text-xs">
            ...
            <div class="font-bold text-white">Sincronización Inmediata</div>
            <p class="text-slate-400 leading-relaxed">
